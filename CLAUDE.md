...
**강의를 전자책처럼 볼 수 있게 렌더링하는 기능 신설**: 사용자가 노션 페이지와 스크린샷 2장을 예시로 보여주며 요청 — 강의 게시글을 제목+자동 목차+소제목+굵은 글씨+정의박스(콜아웃)+태그 칩으로 꾸밀 수 있게, 그리고 "나중에 영상 강의도 올릴 거라 미리 몇 가지 기능을 추가해달라"고 함.
